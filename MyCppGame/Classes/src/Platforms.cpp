...
Platforms::Platforms(GameStates & gameState) :
...
Platforms * Platforms::create(Vec2 position, GameStates & gameState)
{
	...
	Platforms* pSprite = new Platforms(gameState);
...
void Platforms::handleTouchEvent(cocos2d::Touch* touch)
{
...
bool Platforms::isTouched() const
{
	return m_touched;
}
